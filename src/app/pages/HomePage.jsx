        ...
        <ContentWrapper>
          ...
          <ContentRight>
            ...
            <LogoWrapper>
              ...
              <ul>
                <li style={{ fontSize: "13px" }}>Quality: We are committed to providing our customers with high-quality services and products.</li>
                <li style={{ fontSize: "13px" }}>Integrity: We believe in conducting our business with honesty and transparency, and we hold ourselves to the highest ethical standards.</li>
                <li style={{ fontSize: "13px" }}>Customer Service: Our customer's satisfaction is our top priority, and we go above and beyond to ensure that they are happy with the services we provide.</li>
                <li style={{ fontSize: "13px" }}>TV Repair: Our team of experienced technicians offers professional TV repair services for all types of television models. We have the skills and experience necessary to diagnose and fix a wide range of problems, including TV that have no display, no power, audio issues, and more.</li>
                <li style={{ fontSize: "13px" }}>Insurance Salvage Management: In addition to TV repair services, we also specialize in the management of insurance salvage. Our team has extensive experience in the insurance industry, and we are equipped to handle all aspects of the insurance salvage process, from initial assessment to final disposal.</li>
              </ul>
