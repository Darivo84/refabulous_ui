...
const LogosPanel = () => {
  return (
    <div className="LogosPanel">
      <div className="panels">
        <div>
          <img className="brands" src={ Samsung } alt="logo" />
        </div>
        <div>
          <img src={ LG } alt="logo" />
        </div>
      ...
      <div className="panels">
        <div>
          <img src={ Smeg } alt="logo" />
        </div>
        <div>
          <img src={ KitchenAid } alt="logo" />
        </div>
      </div>
    </div>
  )
